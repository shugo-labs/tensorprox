...
class Attack(ABC):
    ...
    def generate_random_ip(self) -> str:
        ...
        """
        return f"100.{self.fake.random_int(0, 255)}.{self.fake.random_int(0, 255)}.{self.fake.random_int(2, 254)}"
...
def run_attack_instance(attack_class, target_ips, interface, duration, label_identifier, min_port, max_port, reserved_percentage=20):
    ...
    # Note: reserved_cores parameter is no longer used in the new core splitting logic
    ...
    try:
        attack_instance = attack_class(
            ...
            min_port=min_port,
            max_port=max_port,
            reserved_cores=reserved_percentage  # This parameter is no longer used but kept for compatibility
        )
    except TypeError:

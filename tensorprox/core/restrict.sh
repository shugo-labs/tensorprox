...
declare -a ALLOWED_COMMANDS=(
    ...
    "/usr/bin/sha256sum /home/$restricted_user/tensorprox/tensorprox/core/immutable/extract_scratch_image.sh"
    ...
    "/usr/bin/sha256sum /home/$restricted_user/tensorprox/tensorprox/core/immutable/*_challenge_v1_0_0.tar.enc"
    ...
    "/usr/bin/bash /home/$restricted_user/tensorprox/tensorprox/core/immutable/extract_scratch_image.sh"
    ...
    # Allow dockersafe execution from immutable directory with validator-controlled nonce
    "/home/$restricted_user/tensorprox/tensorprox/core/immutable/dockersafe_verified_*"

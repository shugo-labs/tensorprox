...
declare -a ALLOWED_COMMANDS=(
    ...
    "/usr/bin/sha256sum /home/$restricted_user/tensorprox/tensorprox/core/immutable/challenge_v1_0_0.tar.enc"
    ...
    "/usr/bin/test -f /home/$restricted_user/tensorprox/tensorprox/core/immutable/challenge_v1_0_0.tar.enc"
    "/usr/bin/scp -t /home/$restricted_user/tensorprox/tensorprox/core/immutable/*"
    ...
    "/usr/bin/docker run --network host --cap-add NET_ADMIN --cap-add NET_RAW challenge_v1_0_0:latest"   
)
EOF_COMMANDS
